...
var DerbyRouteInstance = require('./controllers/DerbyRouteInstance');
var ServerRouteInstance = require('./controllers/ServerRouteInstance');

module.exports = Route;

function Route(router, opts){
  var defaultOptions = {
    derbyController: DerbyRouteInstance,
    serverController: ServerRouteInstance
  };
...
Route.prototype.derbyAction = function(page, model, params, next){
  new this.opts.derbyController(this, page, model, params, next);
};

Route.prototype.serverAction = function(req, res, next){
  new this.opts.serverController(this, req, res, next);
};
